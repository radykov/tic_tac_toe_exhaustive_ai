This does a Depth First Search on all the possible permutations on Tic Tac Toe or Toe Tac Tic (tic tac toe where the goal is to make the other player win)
